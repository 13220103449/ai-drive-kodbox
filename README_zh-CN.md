...
当前 AI Drive 扩展版本为 **0.6.0**：新增挂载盘伪回收站与挂载盘历史版本。删除只会把内容移动到挂载根目录的 `AI Drive回收站(勿删)`；覆盖前的旧文件保存在 `AI Drive历史版本(勿删)`，不会占用 NAS 本地版本空间。
...
<p align="center">
  ...
  <a href="https://github.com/kalcaddle/kodbox/blob/main/ChangeLog.md" target="_blank">更新日志</a>
</p>
