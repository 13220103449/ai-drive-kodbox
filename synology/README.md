...
Then install `dist/AI-Drive-0.3.3-0004-noarch.spk` from Package Center → Manual Install. The package registers a dedicated Web Station portal on port `8091`; open it at `http://NAS_ADDRESS:8091/`.
